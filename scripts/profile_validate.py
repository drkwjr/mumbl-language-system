...
def create_example_profile(output_path: Path) -> None:
    ...
    example_profile = LanguageProfileV1(
        ...
        g2p_rules=[
            {"pattern": "tion$", "ipa": "ʃən", "priority": 10},
            {"pattern": "th", "ipa": "θ", "conditions": {"position": "initial"}, "priority": 5},
        ],
        g2p_overrides=[{"word": "the", "ipa": "ðə", "notes": "Most common pronunciation"}],
...
Examples:
  ...
  python scripts/profile_validate.py --create-example example_profile.json
    ...
    parser.add_argument("files", nargs="*", type=Path, help="Profile JSON files to validate")
