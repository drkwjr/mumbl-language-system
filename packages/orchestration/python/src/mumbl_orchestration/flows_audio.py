    ...
    with get_connection() as conn:
        ...
        for input_item in man.inputs:
            ...
            result = processor.process_youtube(
                url=url, language=man.language, batch_id=man.batch_id, dialect=man.dialect
            )

            # Store segments in database
            segment_ids = audio_repo.insert_many(result["segments"], batch_id=man.batch_id)
            ...
            audio_repo.export_to_csv(csv_path, batch_id=man.batch_id, lang=man.language)
