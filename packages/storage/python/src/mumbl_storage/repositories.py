...
class AudioSegmentRepository:
    ...
    def insert(self, segment: AudioSegment, batch_id: Optional[str] = None, **kwargs) -> Optional[int]:
    ...
    def insert_many(self, segments: List[Dict[str, Any]], batch_id: Optional[str] = None) -> List[Optional[int]]:
    ...
    def export_to_csv(self, output_path: str, batch_id: Optional[str] = None, lang: Optional[str] = None) -> int:
        """
        ...
        fieldnames = [
            'audio_file', 'start_time', 'end_time', 'speaker_id',
            'transcript_text', 'lang', 'dialect', 'dialect_probs',
            'alignment_confidence', 'diarization_confidence', 'granularity',
            'sample_rate', 'batch_id'
        ]
        ...
        with open(output_path, 'w', newline='', encoding='utf-8') as f:
            ...
            for row in rows:
                ...
                csv_row = {
                    ...
                    'dialect_probs': json.dumps(row['dialect_probs']) if row.get('dialect_probs') else None,
...
class DatasetRepository:
    ...
    def list_by_language(self, language: str, dataset_type: Optional[str] = None) -> List[Dict[str, Any]]:
