...
from radio_ingestion.orchestration.task_queue import TaskQueue, ShardTask, TaskState
...
async def test_scheduler_task_execution():
    ...
    scheduler.register_task(
        name="test_task",
        interval_seconds=1.0,  # Run every second for test
