...
class TestTaskQueue:
    ...
    def test_get_tasks_by_state(self, queue):
        ...
        task1 = ShardTask(shard_id=1, source_id=1, local_path="/test1.wav", state=TaskState.CAPTURED)
        task2 = ShardTask(shard_id=2, source_id=1, local_path="/test2.wav", state=TaskState.PREFILTERED)
        task3 = ShardTask(shard_id=3, source_id=1, local_path="/test3.wav", state=TaskState.CAPTURED)
