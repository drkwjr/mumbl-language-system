...
from radio_ingestion.storage.s3_uploader import S3Uploader, LocalStaging
...
class TestS3Uploader:
    ...
    def test_generate_s3_path(self):
        ...
        path = uploader.generate_s3_path(
            country="SO",
            station_name="Radio Muqdisho",
            filename="stream_20250101_120000.wav"
        )
...
class TestFileCleanup:
    ...
    def test_cleanup_old_files(self, tmp_path):
        ...
        deleted = cleanup.cleanup_old_files(
            str(tmp_path),
            extension=".wav",
            older_than_days=1
        )
