...
class TestStationAggregator:
    ...
    def test_aggregate_single_language(self):
        ...
        segments = [
            {"primary_lang": "so", "lang_probs": {"so": 0.9}, "confidence": 0.9, "duration": 10.0, "is_speech": True},
            {"primary_lang": "so", "lang_probs": {"so": 0.8}, "confidence": 0.8, "duration": 15.0, "is_speech": True},
        ]
    ...
    def test_aggregate_multiple_languages(self):
        ...
        segments = [
            {"primary_lang": "so", "lang_probs": {"so": 0.9, "en": 0.1}, "confidence": 0.9, "duration": 10.0, "is_speech": True},
            {"primary_lang": "en", "lang_probs": {"en": 0.8, "so": 0.2}, "confidence": 0.8, "duration": 15.0, "is_speech": True},
            {"primary_lang": "so", "lang_probs": {"so": 0.7, "ar": 0.3}, "confidence": 0.7, "duration": 20.0, "is_speech": True},
        ]
    ...
    def test_aggregate_switch_rate(self):
        ...
        segments = [
            {"primary_lang": "so", "lang_probs": {"so": 0.9}, "confidence": 0.9, "duration": 15.0, "is_speech": True},
            {"primary_lang": "en", "lang_probs": {"en": 0.9}, "confidence": 0.9, "duration": 15.0, "is_speech": True},
            {"primary_lang": "so", "lang_probs": {"so": 0.9}, "confidence": 0.9, "duration": 15.0, "is_speech": True},
        ]
    ...
    def test_aggregate_speech_ratio(self):
        ...
        segments = [
            {"primary_lang": "so", "lang_probs": {"so": 0.9}, "confidence": 0.9, "duration": 10.0, "is_speech": True},
            {"primary_lang": "so", "lang_probs": {"so": 0.9}, "confidence": 0.9, "duration": 10.0, "is_speech": False},  # Not speech
            {"primary_lang": "so", "lang_probs": {"so": 0.9}, "confidence": 0.9, "duration": 10.0, "is_speech": True},
        ]
    ...
    def test_aggregate_confidence_stats(self):
        ...
        segments = [
            {"primary_lang": "so", "lang_probs": {"so": 0.9}, "confidence": 0.9, "duration": 10.0, "is_speech": True},
            {"primary_lang": "so", "lang_probs": {"so": 0.8}, "confidence": 0.8, "duration": 10.0, "is_speech": True},
            {"primary_lang": "so", "lang_probs": {"so": 0.7}, "confidence": 0.7, "duration": 10.0, "is_speech": True},
        ]
