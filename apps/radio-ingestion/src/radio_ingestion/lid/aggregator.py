...
class StationAggregator:
    ...
    def aggregate_hourly(
        self, segments: List[Dict[str, Any]], hour: Optional[datetime] = None
    ) -> Dict[str, Any]:
        """
        ...
        if total_duration > 0:
            lang_mix = {lang: count / total_duration for lang, count in lang_counts.items()}
        else:
            lang_mix = {}
        ...
        all_confidences = [conf for confs in lang_confidences.values() for conf in confs]
