...
from mumbl_data_contracts.segments import TextSegment, SourceRef, Labels
    ...
    def _compile_stats(
        ...
        for s in segments:
            if s.labels.register_type:
                register_counts[s.labels.register_type] = register_counts.get(s.labels.register_type, 0) + 1
